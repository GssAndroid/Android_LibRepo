...
public class SalesProAppCustomersConstraints implements KvmSerializable, Serializable{
    ...
    public SalesProAppCustomersConstraints (){}
    

    public SalesProAppCustomersConstraints (String[] values) {
    	OBJECT_ID = values[0];
...
}//End of class SalesProAppCustomersConstraints 