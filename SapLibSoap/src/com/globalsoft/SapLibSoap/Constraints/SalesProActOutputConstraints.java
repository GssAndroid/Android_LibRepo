...
public class SalesProActOutputConstraints implements KvmSerializable, Serializable{
    ...
    public SalesProActOutputConstraints (){}    

    public SalesProActOutputConstraints (String[] values) {
        KUNNR = values[0];
        KUNNR_NAME = values[1];
        PARNR = values[2];
        PARNR_NAME = values[3];
        ...
        DOCUMENTTYPE_DESCRIPTION = values[18];
        POSTING_DATE = values[19];
    }
...
}//End of class SalesProActOutputConstraints 