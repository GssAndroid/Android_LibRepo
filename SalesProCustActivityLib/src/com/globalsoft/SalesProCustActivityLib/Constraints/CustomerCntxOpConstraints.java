...
public class CustomerCntxOpConstraints  implements KvmSerializable, Serializable {
    ...
    public CustomerCntxOpConstraints (){}

    public CustomerCntxOpConstraints (String[] values) {
        CNTXT2 = values[0];
        CNTXT3 = values[1];
        CNTXT4 = values[2];
        NAME = values[3];
...
}//End of class CustomerCntxOpConstraints 