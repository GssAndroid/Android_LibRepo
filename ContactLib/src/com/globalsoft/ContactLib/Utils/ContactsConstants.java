package com.globalsoft.ContactLib.Utils;
...
public final class ContactsConstants {
    ...
    public static String APPL_NAME_CALL_ACTIVITY_VIEW = "ActivityView";
    ...
    //Preference Related Constant
  	public static String PREFS_NAME_FOR_CONTACTS = "contactsPrefs";
  	public static String PREFS_KEY_CONTACTS_FOR_MYSELF_GET = "CONTACTS-FOR-MYSELF-GET";
